/**
 * WaveSpeed — client AI-upscale adapter (proxy path; upscale-only enhancer).
 * @module gui/providers/wavespeed/code/upscale
 */
...
export default function upscale({ image, key, signal }) {
  ...
  return callUpscaleProxy({ providerId: "wavespeed", image: served, key, signal });
}
