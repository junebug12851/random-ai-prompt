/**
 * Segmind — client AI-upscale adapter (proxy path; upscale-only enhancer).
 * @module gui/providers/segmind/code/upscale
 */
...
export default function upscale({ image, key, signal }) {
  ...
  return callUpscaleProxy({ providerId: "segmind", image: served, key, signal });
}
