/**
 * Deep-Image.ai — client AI-upscale adapter (proxy path; upscale-only enhancer).
 * @module gui/providers/deepimage/code/upscale
 */
...
export default function upscale({ image, key, signal }) {
  ...
  return callUpscaleProxy({ providerId: "deepimage", image: served, key, signal });
}
