/**
 * Claid — client AI-upscale adapter (proxy path; upscale-only enhancer).
 * @module gui/providers/claid/code/upscale
 */
...
export default function upscale({ image, key, signal }) {
  ...
  return callUpscaleProxy({ providerId: "claid", image: served, key, signal });
}
