/**
 * VanceAI — client AI-upscale adapter (proxy path; upscale-only enhancer).
 * @module gui/providers/vanceai/code/upscale
 */
...
export default function upscale({ image, key, signal }) {
  ...
  return callUpscaleProxy({ providerId: "vanceai", image: served, key, signal });
}
