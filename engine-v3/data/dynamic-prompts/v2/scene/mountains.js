...
/**
 * @file
 * @brief Full dynamic-prompt generator (#mountains): a complete, self-standing scene. See notes/reference/dynamic-prompts.md.
 */

import _ from "lodash";

/**
 * Generate the `#mountains` dynamic-prompt fragment. See notes/reference/dynamic-prompts.md.
