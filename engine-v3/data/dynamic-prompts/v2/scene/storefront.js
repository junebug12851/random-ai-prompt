...
/**
 * @file
 * @brief Full dynamic-prompt generator (#storefront): a complete, self-standing scene. See notes/reference/dynamic-prompts.md.
 */

import _ from "lodash";

/**
 * Generate the `#storefront` dynamic-prompt fragment. See notes/reference/dynamic-prompts.md.
