...
/**
 * @file
 * @brief Legacy v1 dynamic-prompt generator (#room-v1): a frozen, monolithic version of the scene, kept for reproducibility. See notes/reference/dynamic-prompts.md.
 */
...
/**
 * Generate the `#room-v1` dynamic-prompt fragment. See notes/reference/dynamic-prompts.md.
...
export default function (settings, imageSettings, upscaleSettings) {
  ...
  let prompt = "room, interrior, {room}";
