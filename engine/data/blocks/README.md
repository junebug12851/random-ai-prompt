...
loaders ignore `_`-prefixed files entirely (the same convention as `engine/data/lists/`). A folder
...
Generators import shared helpers out of `src/` (e.g. `../../../engine/helpers/keywordRepeater.js`
