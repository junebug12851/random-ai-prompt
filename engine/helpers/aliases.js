/**
 * @file
 * @brief The two built-in list aliases (keyword / artist), kept dependency-free so the block chain stays browser-safe.
 */
...
// `listFiles.js`, which imports `node:fs`) keeps the whole block chain
