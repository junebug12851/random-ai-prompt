...
/**
 * @file
 * @brief Partial dynamic-prompt fragment (#room-state): a building block composed into full prompts. See notes/reference/dynamic-prompts.md.
 */

import _ from "lodash";

/**
 * Generate the `#room-state` dynamic-prompt fragment. See notes/reference/dynamic-prompts.md.
