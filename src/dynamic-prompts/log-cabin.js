...
/**
 * @file
 * @brief Full dynamic-prompt generator (#log-cabin): a complete, self-standing scene. See notes/reference/dynamic-prompts.md.
 */

import _ from "lodash";

/**
 * Generate the `#log-cabin` dynamic-prompt fragment. See notes/reference/dynamic-prompts.md.
