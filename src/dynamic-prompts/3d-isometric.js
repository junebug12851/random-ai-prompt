...
/**
 * @file
 * @brief Full dynamic-prompt generator (#3d-isometric): a complete, self-standing scene. See notes/reference/dynamic-prompts.md.
 */
...
/**
 * Generate the `#3d-isometric` dynamic-prompt fragment. See notes/reference/dynamic-prompts.md.
