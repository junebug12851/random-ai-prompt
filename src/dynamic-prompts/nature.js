...
/**
 * @file
 * @brief Partial dynamic-prompt fragment (#nature): a building block composed into full prompts. See notes/reference/dynamic-prompts.md.
 */

import _ from "lodash";

/**
 * Generate the `#nature` dynamic-prompt fragment. See notes/reference/dynamic-prompts.md.
