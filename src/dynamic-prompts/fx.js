...
/**
 * @file
 * @brief Partial dynamic-prompt fragment (#fx): a building block composed into full prompts. See notes/reference/dynamic-prompts.md.
 */

import _ from "lodash";

/**
 * Generate the `#fx` dynamic-prompt fragment. See notes/reference/dynamic-prompts.md.
