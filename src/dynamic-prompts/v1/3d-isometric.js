...
/**
 * @file
 * @brief Legacy v1 dynamic-prompt generator (#3d-isometric-v1): a frozen, monolithic version of the scene, kept for reproducibility. See notes/reference/dynamic-prompts.md.
 */
