...
/**
 * @file
 * @brief Legacy v1 dynamic-prompt generator (#fluffy-animal-v1): a frozen, monolithic version of the scene, kept for reproducibility. See notes/reference/dynamic-prompts.md.
 */
...
/**
 * Generate the `#fluffy-animal-v1` dynamic-prompt fragment. See notes/reference/dynamic-prompts.md.
