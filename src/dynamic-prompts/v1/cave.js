...
/**
 * @file
 * @brief Legacy v1 dynamic-prompt generator (#cave-v1): a frozen, monolithic version of the scene, kept for reproducibility. See notes/reference/dynamic-prompts.md.
 */
...
function maybeAddColor() {
  ...
  if (_.random(0.0, 1.0, true) < 0.5) glow += "glowing ";

  if (_.random(0.0, 1.0, true) < 0.5) return `${glow}{color} `;
  else return "";
}
...
function waterCave() {
  ...
  if (_.random(0.0, 1.0, true) < 0.5) prompt += `, ${maybeAddColor()}reef`;

  if (_.random(0.0, 1.0, true) < 0.5) prompt += `, ${maybeAddColor()}coral`;

  if (_.random(0.0, 1.0, true) < 0.5) prompt += `, ${maybeAddColor()}starfish`;

  if (_.random(0.0, 1.0, true) < 0.5) prompt += `, ${maybeAddColor()}fish`;
...
function crystalCave() {
  ...
  if (_.random(0.0, 1.0, true) < 0.5) prompt += `, ${maybeAddColor()}crystal walls`;

  if (_.random(0.0, 1.0, true) < 0.5) prompt += `, ${maybeAddColor()}crystal floor`;

  if (_.random(0.0, 1.0, true) < 0.5) prompt += `, ${maybeAddColor()}giant crystals`;
...
/**
 * Generate the `#cave-v1` dynamic-prompt fragment. See notes/reference/dynamic-prompts.md.
...
export default function (settings, imageSettings, upscaleSettings) {
  ...
  if (_.random(0.0, 1.0, true) < 0.5) prompt += ", subterranean";

  if (_.random(0.0, 1.0, true) < 0.5) prompt += ", interior";
  ...
  if (_.random(0.0, 1.0, true) < 0.5) prompt += ", cavern";
  ...
  if (_.random(0.0, 1.0, true) < 0.5) prompt += `, ${maybeAddColor()}plants`;

  if (_.random(0.0, 1.0, true) < 0.5) prompt += `, ${maybeAddColor()}vegetation`;

  if (_.random(0.0, 1.0, true) < 0.5) prompt += ", structures";

  if (_.random(0.0, 1.0, true) < 0.5) prompt += `, ${maybeAddColor()}crystal`;

  if (_.random(0.0, 1.0, true) < 0.5) prompt += `, ${maybeAddColor()}gemstone`;
  ...
  if (_.random(0.0, 1.0, true) < 0.5) prompt += ", oasis";

  if (_.random(0.0, 1.0, true) < 0.5) prompt += ", life";

  if (_.random(0.0, 1.0, true) < 0.5) prompt += ", animal";

  if (_.random(0.0, 1.0, true) < 0.5) prompt += ", insect";

  if (_.random(0.0, 1.0, true) < 0.5) prompt += ", bat";
  ...
  const flowerCount = _.random(0.0, 1.0, true) < 0.5 ? _.random(0, 3, false) : 0;
  const treeCount = _.random(0.0, 1.0, true) < 0.5 ? _.random(0, 3, false) : 0;
  ...
  if (_.random(0.0, 1.0, true) < 0.5) prompt += ", dark";

  if (_.random(0.0, 1.0, true) < 0.5) prompt += ", eerie";

  if (_.random(0.0, 1.0, true) < 0.5) prompt += ", scary";

  if (_.random(0.0, 1.0, true) < 0.5) prompt += ", worn down";

  if (_.random(0.0, 1.0, true) < 0.5) prompt += ", weathered";

  if (_.random(0.0, 1.0, true) < 0.5) prompt += ", mysterious";

  if (_.random(0.0, 1.0, true) < 0.5) prompt += ", underground";
