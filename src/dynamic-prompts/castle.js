...
/**
 * @file
 * @brief Full dynamic-prompt generator (#castle): a complete, self-standing scene. See notes/reference/dynamic-prompts.md.
 */

import _ from "lodash";

/**
 * Generate the `#castle` dynamic-prompt fragment. See notes/reference/dynamic-prompts.md.
