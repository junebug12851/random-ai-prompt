...
/**
 * @file
 * @brief Full dynamic-prompt generator (#great-tree): a complete, self-standing scene. See notes/reference/dynamic-prompts.md.
 */

import _ from "lodash";

/**
 * Generate the `#great-tree` dynamic-prompt fragment. See notes/reference/dynamic-prompts.md.
