...
/**
 * @file
 * @brief Partial dynamic-prompt fragment (#expressive): a building block composed into full prompts. See notes/reference/dynamic-prompts.md.
 */

import _ from "lodash";

/**
 * Generate the `#expressive` dynamic-prompt fragment. See notes/reference/dynamic-prompts.md.
