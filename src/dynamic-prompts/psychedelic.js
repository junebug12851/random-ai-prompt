...
/**
 * @file
 * @brief Full dynamic-prompt generator (#psychedelic): a complete, self-standing scene. See notes/reference/dynamic-prompts.md.
 */
...
/**
 * Generate the `#psychedelic` dynamic-prompt fragment. See notes/reference/dynamic-prompts.md.
