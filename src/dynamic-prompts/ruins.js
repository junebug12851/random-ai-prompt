...
/**
 * @file
 * @brief Full dynamic-prompt generator (#ruins): a complete, self-standing scene. See notes/reference/dynamic-prompts.md.
 */

import _ from "lodash";

/**
 * Generate the `#ruins` dynamic-prompt fragment. See notes/reference/dynamic-prompts.md.
