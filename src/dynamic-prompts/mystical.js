...
/**
 * @file
 * @brief Partial dynamic-prompt fragment (#mystical): a building block composed into full prompts. See notes/reference/dynamic-prompts.md.
 */

import _ from "lodash";

/**
 * Generate the `#mystical` dynamic-prompt fragment. See notes/reference/dynamic-prompts.md.
