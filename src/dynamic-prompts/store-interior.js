...
/**
 * @file
 * @brief Full dynamic-prompt generator (#store-interior): a complete, self-standing scene. See notes/reference/dynamic-prompts.md.
 */

import _ from "lodash";

/**
 * Generate the `#store-interior` dynamic-prompt fragment. See notes/reference/dynamic-prompts.md.
