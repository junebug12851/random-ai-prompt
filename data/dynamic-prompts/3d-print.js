...
/**
 * @file
 * @brief Full dynamic-prompt generator (#3d-print): a complete, self-standing scene. See notes/reference/dynamic-prompts.md.
 */
...
/**
 * Generate the `#3d-print` dynamic-prompt fragment. See notes/reference/dynamic-prompts.md.
