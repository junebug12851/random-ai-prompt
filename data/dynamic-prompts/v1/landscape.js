...
/**
 * @file
 * @brief Legacy v1 dynamic-prompt generator (#landscape-v1): a frozen, monolithic version of the scene, kept for reproducibility. See notes/reference/dynamic-prompts.md.
 */
...
/**
 * Generate the `#landscape-v1` dynamic-prompt fragment. See notes/reference/dynamic-prompts.md.
