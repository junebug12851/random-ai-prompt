...
/**
 * @file
 * @brief Full dynamic-prompt generator (#city): a complete, self-standing scene. See notes/reference/dynamic-prompts.md.
 */

import _ from "lodash";

/**
 * Generate the `#city` dynamic-prompt fragment. See notes/reference/dynamic-prompts.md.
