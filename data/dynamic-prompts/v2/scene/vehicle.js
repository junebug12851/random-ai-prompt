...
/**
 * @file
 * @brief Full dynamic-prompt generator (#vehicle): a complete, self-standing scene. See notes/reference/dynamic-prompts.md.
 */
...
/**
 * Generate the `#vehicle` dynamic-prompt fragment. See notes/reference/dynamic-prompts.md.
 * @returns {string} The generated prompt fragment.
 */
export default function () {
  // Start with base prompt
  let prompt = "vehicle, {scene/vehicle}";
