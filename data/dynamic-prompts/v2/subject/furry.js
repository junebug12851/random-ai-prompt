...
/**
 * @file
 * @brief Full dynamic-prompt generator (#furry): a complete, self-standing scene. See notes/reference/dynamic-prompts.md.
 */
...
/**
 * Generate the `#furry` dynamic-prompt fragment. See notes/reference/dynamic-prompts.md.
