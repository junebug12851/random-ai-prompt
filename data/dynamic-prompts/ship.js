...
/**
 * @file
 * @brief Full dynamic-prompt generator (#ship): a complete, self-standing scene. See notes/reference/dynamic-prompts.md.
 */
...
/**
 * Generate the `#ship` dynamic-prompt fragment. See notes/reference/dynamic-prompts.md.
