 ...
 * provider's "Batch chunk size" — see providers/_shared/settings/concurrency.js; prompt-rewrite calls
...
import { effectiveConcurrency } from "../../../providers/_shared/settings/concurrency.js";
...
export function useImageBatches({ settings, provider, flat }) {
  ...
  // size" (its provider-settings gear — see providers/_shared/settings/concurrency.js). This is what
