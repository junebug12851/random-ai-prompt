/**
 * Picsart — client AI-upscale adapter (proxy path; upscale-only enhancer).
 * @module gui/providers/picsart/code/upscale
 */
...
export default function upscale({ image, key, signal }) {
  ...
  return callUpscaleProxy({ providerId: "picsart", image: served, key, signal });
}
