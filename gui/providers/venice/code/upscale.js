/**
 * Venice AI — client AI-upscale adapter (proxy path; upscale-only enhancer).
 * @module gui/providers/venice/code/upscale
 */
...
export default function upscale({ image, key, signal }) {
  ...
  return callUpscaleProxy({ providerId: "venice", image: served, key, signal });
}
