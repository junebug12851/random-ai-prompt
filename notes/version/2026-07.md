...
all), added `notes/reference/{engineering-quality,planning,research-capture,working-rhythm,
self-hosted-assets,agent-tooling}.md`, each mapping the hub canonical to how this project already
...
all six in the [compliance audit matrix](../reference/compliance.md), and index/folder-map entries in
