...
one-line hydrate gate in `App.jsx`. A new **Manage → Storage / Cache** panel
(`components/manage/ManageStorage.jsx`) lists every stored namespace and supports view / delete /
clear-all / export-import (settings portability). Verify: lint 0 errors, smoke, **Node unit 242**,
**web 265**, gui build green. MINOR 2.28.18 → 2.29.0. (The cache panel is local-mode only for now — an
online localStorage manager is still open.)
