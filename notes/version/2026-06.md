...
@axe-core/playwright. Result: **118 Vitest tests green** (88 Node + 30 SPA); the Playwright suite is
authored and configured (browser via `npx playwright install chromium`). Discovered + documented landmine:
