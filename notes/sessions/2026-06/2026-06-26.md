...
- **Flat blocks.** Moved `data/blocks/v3/*` up to `data/blocks/*` and ripped out
  the now-vestigial version machinery (v1/v2 were deleted in 2.7.0; `v3/` was the lone tree). `block.js`
