...
_Retrospective note: the changelog dates 2.60.1 `2026-07-13`, but git authored these commits late on
`2026-07-12` local time — a timezone artifact, the same work, not a second day. The session log lives
under 07-12 (when the work happened); the release entry under 07-13 (the changelog's date)._
