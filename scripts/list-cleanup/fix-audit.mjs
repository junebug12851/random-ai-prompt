...
const MOVE = {
  "look/emotion": {
    grinning: "look/expression",
    "tongue out": "look/expression",
    yawning: "look/action",
  },
  ...
  "lore/mythology": {
    Sasquatch: "nature/mythological-creature",
    Thunderbird: "nature/mythological-creature",
  },
...
const MOVE_T = {
  "nature/mythological-creature": {
    "Agni Hindu": ["lore/mythology", "Agni"],
    "Geb Egyptian": ["lore/mythology", "Geb"],
    "Hades Greek": ["lore/mythology", "Hades"],
    "Neptune Roman": ["lore/mythology", "Neptune"],
    "Odin Norse": ["lore/mythology", "Odin"],
    "Thor Norse": ["lore/mythology", "Thor"],
    "Zeus Greek": ["lore/mythology", "Zeus"],
    "Loki Norse": ["lore/mythology", "Loki"],
    "Aesir Norse": ["lore/mythology", "Aesir"],
    "Quetzalcoatl Aztec": ["lore/mythology", "Quetzalcoatl"],
    "Venus Lovecraftian": ["lore/mythology", "Venus"],
    "Satan Heaven-Abrahamic": ["lore/mythology", "Satan"],
  },
};
...
for (const rel of sources) {
  ...
  for (const line of lines) {
    ...
    if (mvt[line]) {
      const [to, nl] = mvt[line];
      queueAdd(to, nl);
      stats.moved++;
      continue;
    }
    if (mv[line]) {
      queueAdd(mv[line], line);
      stats.moved++;
      continue;
    }
    if (typo[line]) {
...
for (const rel of Object.keys(buf)) {
  const uniq = Array.from(new Set(buf[rel].filter((l) => l.trim() !== ""))).sort((a, b) =>
    a.localeCompare(b),
  );
