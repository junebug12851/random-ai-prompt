...
vi.mock("../../frontend/lib/providers/index.js", async (importOriginal) => ({
  ...(await importOriginal()),
  getProvider: vi.fn(),
}));
vi.mock("../../frontend/lib/output.js", () => ({ ingestImage: vi.fn() }));
vi.mock("../../frontend/lib/rewrite.js", () => ({ rewritePrompt: vi.fn() }));
vi.mock("../../frontend/lib/sessionKeys.js", () => ({ effectiveKey: vi.fn(() => "key") }));
...
import { generateIntoGallery } from "../../frontend/lib/gallery/generateIntoGallery.js";
import { getProvider } from "../../frontend/lib/providers/index.js";
import { ingestImage } from "../../frontend/lib/output.js";
