/**
 * @file Unit tests for the browser-local custom store (gui/src/lib/customStore.js).
 */
import { describe, it, expect } from "vitest";
import { getCustomPresets, saveCustomPreset, removeCustomPreset } from "../frontend/lib/customStore.js";
